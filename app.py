...
os.environ['OPENAI_APT_KEY']='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'
...
if __name__ == "__main__":
    ...
    llm=OpenAIChat(model=llm_model,api_key='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')
